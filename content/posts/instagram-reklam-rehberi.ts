    ...
    tr: {
      ...
      sections: [
        {
          ...
          blocks: [
            {
              type: "p",
              text: "Reklamın kendisinden önce ölçüm altyapısı gelir. Ölçemediğin kampanyayı optimize edemezsin; ilk haftalarda 'işe yarıyor mu?' sorusuna cevap verememek, en sık pes ettiren şeydir.",
            },
            {
              type: "ul",
              items: [
        ...
        },
        {
          ...
          blocks: [
            {
              type: "p",
              text: "Güzellikte kreatif, hedeflemeden daha belirleyicidir. Ama 'kesin işleyen formül' diye pazarlanan her şeye şüpheyle yaklaş — ürünün, fiyatın ve kitlen farklıysa sonucun da farklı olur. Doğru yaklaşım: birkaç farklı açıyı küçük bütçeyle yarıştırmak.",
            },
            {
              type: "ul",
              items: [
        ...
        },
        {
          ...
          blocks: [
            {
              type: "p",
              text: "'Ne kadar bütçeyle başlamalıyım?' sorusunun evrensel bir cevabı yok; ürün fiyatına, marjına ve hedefe bağlı. Ama evrensel olan birkaç ilke var:",
            },
            {
              type: "ul",
              items: [
          ...
          blocks: [
            {
              type: "ul",
              items: [
                "Piksel ve dönüşüm olayları kurulmadan reklam açmak — para harcarsın, hiçbir şey öğrenemezsin.",
                "'Gönderiyi öne çıkar' ile yetinmek — etkileşim alırsın ama satış kampanyasının optimizasyon gücünü kullanmazsın.",
                "Her gün sonuca bakıp panikle kampanya kapatıp açmak — öğrenme fazını sürekli sıfırlarsın.",
                "Tek bir kreatifle yayına çıkmak — yorulduğunda (frequency arttığında) elinde alternatif kalmaz. Yorgunluğun ne zaman başladığını nasıl anlayacağını [kreatif yorgunluğu ve frekans yazımızda](/tr/blog/kreatif-yorgunlugu-reklam-frekansi) anlattık.",
                "Reklamı iyi, ürün sayfası zayıf: reklamın getirdiği kişiyi yavaş açılan, güven vermeyen bir sayfayla karşılamak.",
              ],
            },
          ],
        },
      ...
      faq: [
        ...
        },
        {
          ...
          a: "Küçük bütçede kendi başına başlaman tamamen mümkün — bu rehber bunun için var. Ajans, işin karmaşıklığı arttığında (çoklu kampanya, kreatif üretim ihtiyacı, ölçekleme) zaman ve uzmanlık satın almak anlamına gelir. Dürüst bir ajans, hangi aşamada olduğunu söyler.",
        },
        {
    ...
    en: {
      ...
      sections: [
        {
          ...
          blocks: [
            {
              type: "p",
              text: "Measurement comes before the ad itself. You can't optimize a campaign you can't measure — and not being able to answer 'is this working?' in the first weeks is what makes most people quit.",
            },
            {
              type: "ul",
              items: [
        ...
        },
        {
          ...
          blocks: [
            {
              type: "p",
              text: "In beauty, creative is more decisive than targeting. But be skeptical of anything sold as a 'proven formula' — different product, price and audience means different results. The right approach: race a few distinct angles against each other on a small budget.",
            },
            {
              type: "ul",
              items: [
                "Real usage footage: the product's texture, application, finish — the product itself, not a stock image.",
                "UGC-style delivery: user language, phone-shot feel, honest tone. (If it's creator content, don't pass it off as an organic customer — let it be what it is.)",
                "Problem → solution framing: open with a real annoyance like 'midday shine' and present the product as the fix.",
                "Short copy, single message: one benefit per ad; an ad that lists five benefits communicates none.",
              ],
            },
            {
              type: "p",
        ...
        },
        {
          ...
          blocks: [
            {
              type: "p",
              text: "There's no universal answer to 'how much should I start with' — it depends on your price point, margin and goal. But a few principles are universal:",
            },
            {
              type: "ul",
              items: [
          ...
          blocks: [
            {
              type: "ul",
              items: [
                "Running ads before the pixel and conversion events are set up — you spend money and learn nothing.",
                "Settling for 'Boost post' — you get engagement but never use the optimization power of a sales campaign.",
                "Checking results daily and toggling campaigns in a panic — you keep resetting the learning phase.",
                "Launching with a single creative — when it fatigues (frequency climbs), you have no alternative ready. How to tell when fatigue has actually set in is covered in our [creative fatigue and frequency piece](/en/blog/creative-fatigue-ad-frequency-when-to-refresh).",
                "Great ad, weak product page: sending paid traffic to a slow, trust-poor page.",
              ],
            },
          ],
        },
      ...
      faq: [
        ...
        },
        {
          ...
          a: "Starting on your own with a small budget is entirely doable — that's what this guide is for. An agency buys you time and expertise once complexity grows: multiple campaigns, creative production needs, scaling. An honest agency will tell you which stage you're at.",
        },
        {
