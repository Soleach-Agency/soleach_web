...
export const besHookTesti: BlogPost = {
  ...
  locales: {
    ...
    en: {
      ...
      metaTitle: "Testing Five Hooks: Which One Stops the Scroll? | Soleach",
      metaDescription: "Testing five hooks for one product is the right instinct. Picking the winner wrong is easy: false positive risk, peeking and underpowered tests, with sources.",
